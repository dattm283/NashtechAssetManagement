        ...
        >
            <Box sx={style} border='none'>
                ...
                >
                    ...
                    <Box flex="true" flexDirection="column" >
                        <Typography variant="h6" sx={{ m:"10px 50px"}}>{openDetail.data["staffCode"]}</Typography>
                        <Typography variant="h6" sx={{ m:"10px 50px"}}>{openDetail.data["fullName"]}</Typography>
                        <Typography variant="h6" sx={{ m:"10px 50px"}}>{openDetail.data["userName"]}</Typography>
                        <Typography variant="h6" sx={{ m:"10px 50px"}}>{isDateAndRestyle(openDetail.data["dateOfBirth"])}</Typography>
